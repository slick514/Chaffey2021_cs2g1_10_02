 ...
 * called,
 * the clock stores the alarm. When you call get_time, and the alarm time has been reached or exceeded, return the
 * time followed by the string "Alarm" (or, if you prefer, the string "\u23F0") and clear the alarm. What do you need
 * to do to make the set_alarm function work for WorldClock objects?
 *
 * Exercise P10.1:
